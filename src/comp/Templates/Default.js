        ...
        <div className="left-cont">
          ...
          <div className="work-exp">
            <div className="head">
              ...
              <span className="work-exp">Experiência profissional</span>
            </div>
              ...
              <div className="cards-container">
                ...
                <div className="r">
                  <div className="t">
                    ...
                    <span className="location">Localização da Empresa</span>
                  </div>
                  <br />
                  <div className="b">
                    <span>
                      Sua experiência do que foi realizado no tempo em que estava na empresa.
                    </span>
                  </div>
                </div>
              </div>
          ...
          <div className="education-exp">
            <div className="head">
              <HiBriefcase className="icon" style={iconsStyle.Licon} />
              <span className="education-exp">Educação</span>
            </div>
            {eduStore !== undefined && eduStore.length > 0 ? (
              ...
              <div className="cards-container">
                ...
                <div className="r">
                  <div className="t">
                    <h5>Nome da Instituição e o curso</h5>
                  </div>
                  <br />
                  <div className="b">
                    <span>
          ...
          <div className="cont">
            ...
            <div className="quotes-cont box">
              ...
              <div className="body">
                {quotes === "" ? (
                  <>
                    Escolha uma frase motivacional para seu currículo.
                  </>
                ) : (
                  quotes
                )}
